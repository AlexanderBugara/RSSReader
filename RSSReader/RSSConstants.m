...
NSString *const kBaseURL = @"images.apple.com";
NSString *const kSchemaURL = @"http";
NSString *const kFeedPath = @"/main/rss/hotnews/hotnews.rss";
...
NSString *const kFeedEntity = @"RSSFeed";
